    ...
    <div className="app-layout">
      ...
      <div className="main-content">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12, marginBottom: 24 }}>
          ...
          <StatCard label="Revenue Collected" value={formatCAD(totalRevenue)} accent />
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p style={{ marginBottom: 16 }}>{search ? 'Try a different search term.' : 'Create your first invoice to get started.'}</p>
...
function StatCard({ label, value, accent, warn }) {
  return (
    <div className="card" style={{ padding: '14px 18px' }}>
      ...
      <div style={{ fontSize: 20, fontWeight: 700, color: accent ? 'var(--success)' : warn ? 'var(--danger)' : 'var(--navy)', fontFamily: 'monospace' }}>
        {value}
      </div>
    </div>
  )
